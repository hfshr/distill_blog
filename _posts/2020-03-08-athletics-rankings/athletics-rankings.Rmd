...
This was my first time using the [`rvest`](http://rvest.tidyverse.org/) package, so I'm sure this code can be improved somewhat... It does, however, seem to do the trick! To start, I identified a url from one of the ranking pages that would serve as a starting point to access the site.
...
```{r layout="l-body", fig.align='center'}
