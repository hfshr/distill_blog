...
```{r elite-performances, layout="l-body-outset", fig.height=10, fig.width=10, fig.cap="Elite performance distributions for males and females and different events."}
